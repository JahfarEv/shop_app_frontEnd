...
// import { FiEdit, FiSave, FiX, FiUser, FiPhone, FiMail, FiCreditCard, FiHome, FiDollarSign } from "react-icons/fi";
// import '../stylesheets/SalesmanProfile.css'; // We'll create this CSS file
...
//                     <span className="info-value">{salesman.mobileNumber}</span>
//                   </div>
//                 </div>
//               </div>
...
//                       <span className="info-value">{salesman.bankAccountNumber}</span>
//                     </div>
//                     <div className="info-item">
...
//               {salesman.shopsAddedBySalesman?.length > 0 && (
//                 <div className="profile-section">
//                   <h2 className="section-title">
//                     <FiHome className="section-icon" /> Managed Shops ({salesman.shopsAddedBySalesman.length})
//                   </h2>
//                   <div className="shops-grid">
//                     {salesman.shopsAddedBySalesman.map((shop) => (
...
const SalesmanProfile = () => {
  ...
  return (
    <div className={`salesman-container ${isSidebarOpen ? "sidebar-open" : ""}`}>
      <SalesmanSidebar 
